...
import './Footer.css';
import upkey from './up-gray.png'

const Footer =() =>{
    return(
    <div className="fl w-100 bg-blue" height="200px">
        <div className="bg-black bg-cp">
            <a href="http://localhost:3000/" className=""> 
                <img id='inputimage' alt="up" src={upkey} 
                width='30px' height='auto'/>     
            </a>
        </div>
        <div className="tc-l bg-center cover bg-black ">
            
            <div className="w-100 ph3 pv2 bg-black-80">
                ...
                <a className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" 
                   href="https://github.com/MMazy" title="GitHub">
                    <svg className="dib h2 w2" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" 
                    fill-rule="evenodd" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414">
                ...
                {/* <a className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" 
                  href="https://youtube.com" title="youtube">
                    <svg className="dib w2 h2" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" 
                    fill-rule="evenodd" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414">
                ...
                <a className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" 
                   href="https://www.linkedin.com/in/mina-mazloomi-14018891/" title="LinkedIn">
                ...
                <p className="white-60"> Mina Mazloomi © 2020</p>
            </div>
        </div>
